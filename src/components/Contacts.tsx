      ...
      <div className="rounded-lg border border-[var(--line)] bg-[var(--foreground)] p-6 text-white shadow-[var(--shadow-soft)] sm:p-8">
        <div className="grid gap-8 md:grid-cols-[1fr_auto] md:items-center">
          <div>
            ...
            <p className="mt-4 max-w-2xl text-2xl font-black leading-snug sm:text-3xl">
          ...
          <a
            ...
            className="inline-flex rounded-md bg-[var(--accent)] px-6 py-3 text-sm font-bold text-white shadow-lg shadow-teal-900/10 transition hover:bg-[var(--accent-strong)]"
          >
            이메일 보내기
          </a>
        </div>

        <div className="mt-8 grid gap-4 border-t border-white/10 pt-6 text-sm text-white/70 sm:grid-cols-2">
          <p>
            Email
            <br />
            <a
